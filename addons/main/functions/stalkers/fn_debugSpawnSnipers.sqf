...
private _spots = [_pos, 100, 1000] call VIC_fnc_findDynamicSniperSpots;
...

{
     ...
     [_marker, _sPos, "ICON", "mil_ambush", "#(1,0,0,1)", 0.8, "Debug Sniper"] call VIC_fnc_createGlobalMarker;
