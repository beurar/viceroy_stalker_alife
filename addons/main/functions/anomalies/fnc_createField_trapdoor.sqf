...
if (_count < 0) then {
    ...
    private _dens = ["VSA_anomalyDensity_Trapdoor",100] call viceroy_stalker_alife_cba_fnc_getSetting;
...
private _marker = [_markerName, _site, "ELLIPSE", "", VIC_colorTrapdoorTurq, 1, format ["Trapdoor %1m", _size]] call viceroy_stalker_alife_markers_fnc_createGlobalMarker;
