...
if (_count < 0) then {
    ...
    private _dens = ["VSA_anomalyDensity_Meatgrinder",100] call viceroy_stalker_alife_cba_fnc_getSetting;
...
private _marker = [_markerName, _site, "ELLIPSE", "", VIC_colorMeatRed, 1, format ["Meatgrinder %1m", _size]] call viceroy_stalker_alife_markers_fnc_createGlobalMarker;
