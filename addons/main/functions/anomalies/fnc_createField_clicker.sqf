...
if (_count < 0) then {
    ...
    private _dens = ["VSA_anomalyDensity_Clicker",100] call FUNC(getSetting);
...
private _marker = [_markerName, _site, "ELLIPSE", "", VIC_colorClickerMagenta, 1, format ["Clicker %1m", _size]] call FUNC(createGlobalMarker);
