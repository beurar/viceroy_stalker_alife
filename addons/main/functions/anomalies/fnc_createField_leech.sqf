...
if (_count < 0) then {
    ...
    private _dens = ["VSA_anomalyDensity_Leech",100] call FUNC(getSetting);
...
private _marker = [_markerName, _site, "ELLIPSE", "", VIC_colorLeechGrey, 1, format ["Leech %1m", _size]] call FUNC(createGlobalMarker);
