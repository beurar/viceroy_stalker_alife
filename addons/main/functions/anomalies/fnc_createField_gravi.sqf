...
if (_count < 0) then {
    ...
    private _dens = ["VSA_anomalyDensity_Gravi",100] call FUNC(getSetting);
...
private _marker = [_markerName, _site, "ELLIPSE", "", VIC_colorCopper, 1, format ["Gravi %1m", _size]] call FUNC(createGlobalMarker);
