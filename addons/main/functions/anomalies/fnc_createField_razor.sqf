...
if (_count < 0) then {
    ...
    private _dens = ["VSA_anomalyDensity_Razor",100] call viceroy_stalker_alife_cba_fnc_getSetting;
...
private _marker = [_markerName, _site, "ELLIPSE", "", VIC_colorSilver, 1, format ["Razor %1m", _size]] call viceroy_stalker_alife_markers_fnc_createGlobalMarker;
