...
if (_count < 0) then {
    ...
    private _dens = ["VSA_anomalyDensity_Burner",100] call viceroy_stalker_alife_cba_fnc_getSetting;
...
private _marker = [_markerName, _site, "ELLIPSE", "", VIC_colorPyroOrange, 1, format ["Burner %1m", _size]] call viceroy_stalker_alife_markers_fnc_createGlobalMarker;
