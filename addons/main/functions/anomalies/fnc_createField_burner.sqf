...
if (_count < 0) then {
    ...
    private _dens = ["VSA_anomalyDensity_Burner",100] call FUNC(getSetting);
...
private _marker = [_markerName, _site, "ELLIPSE", "", VIC_colorPyroOrange, 1, format ["Burner %1m", _size]] call FUNC(createGlobalMarker);
