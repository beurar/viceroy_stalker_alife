...
/*
    ...
    Command:
    [] call viceroy_stalker_alife_smart_terrains_fnc_scanMap;
*/

scriptName "viceroy_stalker_alife_smart_terrains_fnc_scanMap";
...

{
    ...
    // Mark the best clusters
    {
        ...
        if (_cCount >= 1) then { // Threshold
            ...
            _icon setMarkerTypeLocal "mil_triangle";
    ...
    for "_yi" from 0 to _countX do {
        ...
        if (_ruins isNotEqualTo []) then {
             ...
             if (!_alreadyMarked) then {
                 ...
                 _icon setMarkerTypeLocal "loc_Ruins";
                 _icon setMarkerColorLocal "ColorGUER";
