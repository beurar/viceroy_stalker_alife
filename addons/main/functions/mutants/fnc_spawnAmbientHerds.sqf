...
private _herdCount = ["VSA_ambientHerdCount", 2] call viceroy_stalker_alife_cba_fnc_getSetting;
private _herdSize  = ["VSA_ambientHerdSize", 4]  call viceroy_stalker_alife_cba_fnc_getSetting;
private _nightOnly = ["VSA_ambientNightOnly", false] call viceroy_stalker_alife_cba_fnc_getSetting;
...
for "_i" from 1 to _herdCount do {
    ...
    [_marker, _pos, "ICON", "mil_dot", VIC_colorMutant, 0.2, "Ambient Herd"] call viceroy_stalker_alife_markers_fnc_createGlobalMarker;
