...
private _max = ["VSA_maxMutantNests", 3] call viceroy_stalker_alife_cba_fnc_getSetting;
if ((count STALKER_mutantNests) >= _max) exitWith {
};

private _nightOnly = ["VSA_nestsNightOnly", true] call viceroy_stalker_alife_cba_fnc_getSetting;
